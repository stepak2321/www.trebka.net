...
if (headerContent) {
    ...
    function updateClock() {
        ...
        clockElement.innerHTML = `${dateString} <strong>${timeString}</strong>`;
    }
    updateClock();
...
/* ===================== AUDIO MANAGEMENT ===================== */
// Audio features disabled - external audio files unavailable
    ...
    terminalInputField.addEventListener('keydown', (e) => {
        ...
        // Tab - autocomplete
            ...
            const commands = ['help', 'status', 'time', 'date', 'clear', 'ping', 'whoami', 'history', 
                            ...
                            'calc', 'echo', 'rot13', 'base64', 'name', 'color', 'secret', 'balls'];
...
function executeTerminalCommand(command) {
    switch (command) {
            case 'help':
                ...
                log('Info: weather');
                log('Fun: joke, fortune, hack, coffee, dance, 42, glitch, balls');
            ...
            case 'dance':
                ...
                break;
            case 'balls':
                log('opening c.trebka.net...');
                setTimeout(() => {
                    window.location.href = 'https://c.trebka.net';
                }, 250);
                break;
            case 'virus':
