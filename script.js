...
// Additional image interactions
let imageClicks2 = 0;
let imageClicks3 = 0;
let imageClicks4 = 0;

document.getElementById('imageSecret2').addEventListener('click', () => {
    imageClicks2++;
    log(`classified data accessed ${imageClicks2}`);
    if (imageClicks2 === 3) {
        log('classified data decrypted');
        secretSound.play().catch(() => {});
    }
});

document.getElementById('imageSecret3').addEventListener('click', () => {
    imageClicks3++;
    log(`system core ping ${imageClicks3}`);
    if (imageClicks3 === 5) {
        log('system core breach detected');
...
document.getElementById('imageSecret4').addEventListener('click', () => {
    imageClicks4++;
    log(`neural network scan ${imageClicks4}`);
    if (imageClicks4 === 4) {
        log('neural network activated');
...
function detectBrowser() {
    ...
    // Check for Chrome first (since many browsers include Chrome in UA)
...
// Call updateSystemInfo after DOM is loaded
document.addEventListener('DOMContentLoaded', () => {
    updateSystemInfo();
    updateHUD(); // Initialize HUD immediately
});
